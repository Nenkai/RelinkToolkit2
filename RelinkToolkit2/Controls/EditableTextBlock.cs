...
internal class EditableTextBlock : WpfControl
{
    ...
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        ...
        if (TextBox != null)
        {
            ...
            TextBox.GetObservable(IsVisibleProperty)
                .Subscribe(new AnonymousObserver<bool>(OnTextBoxVisiblityChanged));
    ...
    private class AnonymousObserver<T> : System.IObserver<T>
    {
        ...
        public AnonymousObserver(System.Action<T> onNext, System.Action<System.Exception>? onError = null, System.Action? onCompleted = null)
        {
            _onNext = onNext;
            _onError = onError;
